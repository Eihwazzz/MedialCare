...
//--CONSTRUCTOR
	...
	{
		if($id_usuario != NULL){
			$obj = Persona::TraerUnaPersona($id_usuario);
...
//--METODO DE CLASE
	...
	public static function TraerUnaPersona2($email,$clave) 
	{	


		$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
		$consulta =$objetoAccesoDato->RetornarConsulta("select * from usuario where mail=:mail AND clave=:pass");
